                          ...
                          if (pickedImage1 == null || pickedImage2 == null) {
                            ...
                            Navigator.pushNamed(context, SelfieClick.routeName,
                                arguments: (widget.arguments.signupArguments != null)
                                    ? NextArgument(
                                        email: widget
                                            .arguments.signupArguments!.email,
                                        password: widget.arguments
                                            .signupArguments!.password,
                                        phone: widget
                                            .arguments.signupArguments!.phone,
                                        fullname: widget
                                            .arguments.signupArguments!.name,
                                        gender: _character
                                            .toString()
                                            .split('.')
                                            .last,
                                    ...
                                    : NextArgument(
                                        email: widget
                                            .arguments.gogArguments!.email,
                                        password: widget
                                            .arguments.gogArguments!.password,
                                        phone: widget
                                            .arguments.gogArguments!.phone,
                                        fullname: widget
                                            .arguments.gogArguments!.fullname,
                                        gender: _character
                                            .toString()
                                            .split('.')
                                            .last,
