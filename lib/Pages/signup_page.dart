...
class SignupArguments {
  ...
  SignupArguments({this.id, this.name, this.email, this.password, this.phone});
}
                      ...
                      onPressed: (() async {
                        if (_frmkey.currentState!.validate()) {
                          ...
                          Navigator.pushNamed(context, NextPage.routeName,
                              arguments: NextPageViewModel(signupType: SignupType.normal,signupArguments: SignupArguments(
                                  email: emailText.text,
                                  name: fullname.text,
                                  phone: phone.text,
                                  password: passwordText.text))); 
